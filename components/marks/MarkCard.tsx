...
export default function MarkCard({ course, index }: Props) {
    ...
    const hasMarks = course.tests.length > 0;
    ...
    return (
        <motion.div
            ...
            style={{
                ...
                opacity: hasMarks ? 1 : 0.6,
            }}
        >
            {/* Header */}
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: hasMarks ? 16 : 0 }}>
