export default function PrivacyPage() {
    return (
        <div style={{
            ...
            <p style={{ color: "#64748b", fontSize: 14, marginBottom: 32 }}>Last updated: August 2026</p>
            <section style={{ marginBottom: 32 }}>
                <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 12 }}>What is Clarix?</h2>
                <p style={{ color: "#475569", fontSize: 15 }}>
                    Clarix is an unofficial academia tracker that helps students view their attendance,
            ...
            <section style={{ marginBottom: 32 }}>
                ...
                <ul style={{ color: "#475569", fontSize: 15, paddingLeft: 20 }}>
                    <li style={{ marginBottom: 8 }}>Your NetID / email (to log in to academia portal)</li>
                    <li style={{ marginBottom: 8 }}>Your session cookies (encrypted, stored temporarily)</li>
            ...
            <section style={{ marginBottom: 32 }}>
                ...
                <ul style={{ color: "#475569", fontSize: 15, paddingLeft: 20 }}>
                    <li style={{ marginBottom: 8 }}>❌ We never store your password</li>
            ...
            <section style={{ marginBottom: 32 }}>
                ...
                <ul style={{ color: "#475569", fontSize: 15, paddingLeft: 20 }}>
                    <li style={{ marginBottom: 8 }}>Session cookies are used only to fetch your academic data</li>
            ...
            <section style={{ marginBottom: 32 }}>
                <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 12 }}>Donations</h2>
                <p style={{ color: "#475569", fontSize: 15, marginBottom: 8 }}>
                    Clarix accepts optional donations via Razorpay to support development and server costs.
                </p>
                <ul style={{ color: "#475569", fontSize: 15, paddingLeft: 20 }}>
                    <li style={{ marginBottom: 8 }}>We do not store any payment information</li>
                    <li style={{ marginBottom: 8 }}>All payment data is handled securely by Razorpay</li>
                    <li style={{ marginBottom: 8 }}>Donations are completely optional and non-refundable</li>
                    <li style={{ marginBottom: 8 }}>Razorpay privacy policy applies to all transactions</li>
                </ul>
            </section>
            <section style={{ marginBottom: 32 }}>
            ...
            <section style={{ marginBottom: 32 }}>
                ...
                <p style={{ color: "#475569", fontSize: 15 }}>
                    Clarix is an independent student project and is not officially affiliated with any
                    educational institution. All academic data displayed is fetched directly from the
                    academia portal using your own credentials. Clarix is provided as-is with no
            ...
            <div style={{
                ...
                ✅ Clarix never stores your password. Your credentials are used only to authenticate with the academia portal.
            </div>
        </div>
    );
}