...
export default function TimetablePage() {
    ...
    const { data, loading, error } = useFetch<TimetableResult>(
    ...
    return (
        <PageWrapper>
            ...
            <div style={{ padding: "0 20px 24px" }}>
                <p style={{ fontSize: 12, color: "#94a3b8", marginBottom: 10, textTransform: "uppercase", letterSpacing: "0.05em" }}>
                    Day Order
                </p>
                                    ...
                                    <div key={ci}>
                                        {ci > 0 && (
                                            <div style={{
                                                ...
                                                margin: "4px 0", borderTop: "1px dashed #e2e8f0", paddingTop: 8,
                                            }}>
                                                or
                                            </div>
                                        )}
                                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                                            ...
                                            <div style={{ textAlign: "right" }}>
                                                ...
                                                <p style={{ fontSize: 12, color: "#64748b", marginTop: 6, fontWeight: 500 }}>
                                                    {course.room}
                                                </p>
                                            </div>
                                        </div>
