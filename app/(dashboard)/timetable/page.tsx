...
// ✅ Shared drawing function used by both PDF and JPEG
...
async function exportTimetableJPEG(
    timetable: Timetable,
    batch: number,
    section: string,
    profile: Student | null
    ...
    // ✅ Convert PDF to JPEG using canvas
    ...
    canvas.width = 2970; // 297mm * 10 for high quality
    canvas.height = 2100; // 210mm * 10
